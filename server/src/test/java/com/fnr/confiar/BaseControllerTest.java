...
public abstract class BaseControllerTest {
  ...
  public void compareResponse(BaseDTO<?> expectedRecord, BaseDTO<?> actualRecord) {
    assertTrue(new ReflectionEquals(expectedRecord).matches(actualRecord));
  }

  public void compareResponses(List<BaseDTO<?>> expectedRecords, List<BaseDTO<?>> actualRecords) {
